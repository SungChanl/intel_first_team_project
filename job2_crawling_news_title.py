...
category = ['idolmaster', 'depression', 'comic', 'm_entertainer', 'drama', 'maplestory', 'bts', 'lostark', 'bitcoins','iamsolo']
pages = [1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000]
df_title = pd.DataFrame()

for category_idx in range(5, 7):
    refined_titles = []
    url_segment = 'https: // gall.dcinside.com / board / lists /?id = maplestory_new & page = 1 & list_num = 100'
